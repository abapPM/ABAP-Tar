...
CLASS zcx_tar_error DEFINITION LOCAL FRIENDS ltcl_split_text ltcl_base.
...
CLASS ltcl_base DEFINITION FOR TESTING RISK LEVEL HARMLESS DURATION SHORT ABSTRACT.
  ...
  PROTECTED SECTION.
    ...
    DATA:
      mo_cut TYPE REF TO zcx_tar_error,
      BEGIN OF ms_given,
        text               TYPE string,
...
CLASS ltcl_base IMPLEMENTATION.
  ...
  METHOD when_instan_using_raise_t100.
    ...
    TRY.
        zcx_tar_error=>raise_t100(
          iv_msgid    = ms_given-t100_message-msgid
...
CLASS ltcl_general IMPLEMENTATION.
  ...
  METHOD no_text.
    ...
    when_instantiated_using_raise( ).
    then_the_text_should_equal( zcx_tar_error=>c_generic_error_msg ).
  ENDMETHOD.
...
CLASS ltcl_get_t100_longtext IMPLEMENTATION.
  ...
  METHOD test01.
    ...
    DATA:
      lx_err    TYPE REF TO zcx_tar_error,
    ...
    TRY.
        ...
        zcx_tar_error=>raise_t100( ).
      CATCH zcx_tar_error INTO lx_err.
...
CLASS ltcl_split_text DEFINITION FOR TESTING DURATION SHORT RISK LEVEL HARMLESS.
...
CLASS ltcl_split_text IMPLEMENTATION.
  ...
  METHOD test_set_msg_vars.
    ...
    ls_msg = zcx_tar_error=>split_text_to_symsg( iv_text ).
